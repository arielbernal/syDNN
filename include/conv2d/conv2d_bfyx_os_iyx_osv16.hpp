...
// class Conv2D_bfyx_os_iyx_osv16 : public Conv2DImplBase {
// public:
//   static const size_t sub_group_size;

//   Conv2D_bfyx_os_iyx_osv16(const cl::Context& context)
...
// bool Conv2D_bfyx_os_iyx_osv16::_registered = Conv2DFactory::register_implementation("Conv2D_bfyx_os_iyx_osv16", false,
//                             [](const cl::Context& context) -> std::unique_ptr<Conv2DImplBase>
//                              { return std::make_unique<Conv2D_bfyx_os_iyx_osv16>(context); }
//                             );
